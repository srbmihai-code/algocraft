...
Trebuie să marchezi toate căsuțele din `traseu` cu clasa `solutie` atunci când găsești ieșirea din labirint (clasa `final`).
Restul implementării este deja făcut.
